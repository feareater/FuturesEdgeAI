...
| A5 | Historical | Full backtest run, validate edge across 12m | ✅ **Done** | Full period (2018-09-24 → 2026-04-01). Full baseline (conf≥65, all setups): Net -$2,637. **or_breakout isolation (conf≥65): Net +$262,465, PF 1.86, 4.2/day, 5m-only signals** — MNQ +$115K leads. zone_rejection@80: Net -$203,810 — raising conf did NOT fix R:R mismatch (AvgWin $16 vs AvgLoss $24). Combined or+zr80+pdh: Net +$12,912 — zone_rejection still destroys the edge. Recommended config: or_breakout+pdh_breakout only. |
